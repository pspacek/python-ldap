% $Id: ldap.tex,v 1.20 2004/05/18 18:15:25 stroeder Exp $
...
\begin{methoddesc}[LDAP]{bind}{who, cred, method} % -> int
     ...
     \methodline[LDAP]{simple_bind}{\optional{who=\constant{''} \optional{, cred=\constant{''}}}} % -> int
     \methodline[LDAP]{simple_bind_s}{\optional{who=\constant{''} \optional{, cred=\constant{''}}}} % -> None
...
\begin{methoddesc}[LDAP]{result}{\optional{ msgid=\constant{RES_ANY} \optional{, all=\constant{1} \optional{, timeout=\constant{-1}}}}} % -> 2-tuple
...
\begin{methoddesc}[LDAP]{result2}{\optional{ msgid=\constant{RES_ANY} \optional{, all=\constant{1} \optional{, timeout=\constant{-1}}}}} % -> 3-tuple
