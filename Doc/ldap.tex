% $Id: ldap.tex,v 1.8 2002/10/27 18:51:13 stroeder Exp $
...
specified by \var{dn} which means it must not already exist.
The argument \var{modlist} is similar to the one passed to \method{modify()},
