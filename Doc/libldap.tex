% $Id: libldap.tex,v 1.1 2001/03/07 14:34:57 leonard Exp $
...
\begin{funcdesc}{open}{host \optional{, port=\constant{PORT}}} % -> LDAPObject
  ...
  (See section~\ref{ldap-objects} for details.)
\end{funcdesc}
...
following methods:
LDAP objects are returned by \function{open()} above, when a
...
See the description of the \method{result()} method
...
The general method \method{bind()}
...
\var{result_data}, otherwise the \var{result_data} is normally meaningless.
