% $Id: libldap.tex,v 1.12 2002/02/09 14:51:23 stroeder Exp $
...
\declaremodule[ldap]{extension}{ldap}		% not standard, in C
...
\subsection{\module{ldap.async} ---
  framework for stream-processing of large search results }


\subsection{\module{ldap.modlist} ---
